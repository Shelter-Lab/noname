		...
		langrensha: {
			...
			connect: {
				...
				connect_player_number: {
					...
					frequent: true,
					restart: true,
					intro: "真人不够的座位由 AI 托管。<br><br>身份表是定长的：<b>普通板 8 个、觉孤板 10 个</b>。<br>少于 8 人会从尾部截断，板子不完整（如 4 人只有狼/民/民/预言家，没有女巫和猎人）；多于身份表长度则多出的席位补成平民（普通板开 10 人就是这种情况，狼人会明显吃亏）。<br>建议：8 人两个板子都行，10 人配觉孤板。",
				},
			...
			config: {
				...
				player_number: {
					name: "游戏人数",
					init: "8",
					// 6~10 人。身份表是定长的（普通板 8 个、觉孤板 10 个），不足则从尾部截断、
					// 超出则补平民（见 mode/langrensha 的 chooseCharacterOL），所以只有
					// 「普通板 8 人」「觉孤板 10 人」是设计原本的样子，其余都是衍生板。
					// 不放 2~5：截到 5 人以下连女巫都没了，只剩狼/民/民/预，没什么可玩的。
					item: {
						6: "六人",
						7: "七人",
						8: "八人",
					...
					frequent: true,
					restart: true,
					// 下面这张表是按 chooseCharacterOL 的截断/补位规则实算出来的，改板子表要同步重算
					intro:
						"除自己以外的座位都由 AI 托管。<br><br><b>普通板</b>（身份表 8 个）<br>" +
						"　6人：狼2 好人4，夜刀3点，<b>缺猎人</b><br>" +
						"　7人：狼3 好人4，夜刀4点，<b>缺猎人</b><br>" +
						"　8人：狼3 好人5，夜刀4点 —— 设计原样<br>" +
						"　9人：狼3 好人6，夜刀4点（多1民）<br>" +
						"　10人：狼3 好人7，夜刀4点（多2民）<br><br>" +
						"<b>觉孤板</b>（身份表 10 个）<br>" +
						"　6人：狼2 好人4，夜刀3点，缺猎人和白狼<br>" +
						"　7人：狼3 好人4，夜刀4点，缺猎人和白狼<br>" +
						"　8/9人：狼3 好人5/6，夜刀4点，缺白狼<br>" +
						"　10人：狼4 好人6，夜刀4点 —— 设计原样<br><br>" +
						"夜刀点数是全队合计、可以叠在同一人身上（狼王在狼刀总数不足4时补1点）。" +
						"所以<b>6/7 人时好人只有4个而夜里要掉3~4血，狼人明显占优</b>，图快可以玩，想公平建议 8 或 10。",
				},
				langrensha_banzi: {
					name: "游玩板子",
					frequent: true,
