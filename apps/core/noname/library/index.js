		...
		langrensha: {
			...
			config: {
				...
				player_number: {
					name: "游戏人数",
					init: "8",
					// 只给 8 和 10：身份表是定长的（普通板 8 个、觉孤板 10 个），
					// 别的人数只会截短或补平民，出来的板子都不是设计过的
					item: {
						8: "八人",
						10: "十人",
					},
					frequent: true,
					restart: true,
					intro: "除自己以外的座位都由 AI 托管。<br><br><b>8 人</b>：两个板子都完整。<br><b>10 人</b>：请配「觉醒孤独少女」板；配「普通」板的话身份表只有 8 个，多出的 2 席会补成平民，狼人这边会明显吃亏。",
				},
				langrensha_banzi: {
					name: "游玩板子",
					frequent: true,
