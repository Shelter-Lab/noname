		...
		langrensha: {
			...
			connect: {
				...
				connect_langrensha_banzi: {
					...
					frequent: true,
					init: "normal",
					// 名字要短，选项条放不下长串。原来叫「普通8人（屠边）」「8-10人觉醒孤独少女（屠城）」，
					// 那个屠边/屠城后缀还会误导 —— 胜负是「游戏结束方式」独立控制的，两项并不联动
					item: {
						normal: "普通",
						juegu: "觉孤",
					},
			...
			config: {
				...
				player_number: {
					...
					frequent: true,
					restart: true,
					// 数字按 mode/langrensha 里的 BANZI 表实算，改板子表要同步改这里
					intro: "除自己以外由 AI 托管。<br>6人 狼2 / 7人 狼2 / 8·9·10人 狼3（觉孤板10人 狼4）。<br>夜刀是全队合计、可叠在同一人身上：狼2 时 3 点，狼3 起 4 点。",
				},
				langrensha_banzi: {
					name: "游玩板子",
					frequent: true,
